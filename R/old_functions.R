...
#' @return NULL
#'
celltype.validation.old <- function(ES, group.by=CLUSTER.LABEL, groups=NULL, threshold=0, marker.prefix=MARKER.PREFIX, verbose=TRUE) {
...
#' @param groups (character) the clusters for signature prediction
#'
signature.validation.old <- function(ES, group.by="CLUSTER", groups=NULL,
                                     diff.threshold=0.05,
                                     sig.n=NULL,
                                     percentages=c(0.2),
                                     repeats=10,
